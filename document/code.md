...
open ParseAndRun;;
fromFile "chl_example/ex6.c";; #查看preinc.c语法树
run (fromFile "chl_example/ex6.c") [];; #解释执行preinc.c
```
...
dotnet run --project microc.fsproj chl_example/ex6.c #查看运行结果
.\machine.exe -trace chl_example/ex6.out 0 #追踪查看运行栈
dotnet fsi #启动fsi
				#注：以下代码在终端的fsi中运行
#r "nuget: FsLexYacc";;
